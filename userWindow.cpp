...
void userWindow::onSendMessagePushButtonClicked()
{
	mm.addMessage(u.ID, ui.buyerCommodityTableWidget->item(ui.buyerCommodityTableWidget->currentRow(), 5)->text(), ui.sendMessageLineEdit->text());
	QMessageBox::information(nullptr, "提示", "留言成功");
}
